...
class _UnitConverterState extends State<UnitConverter> {
  ...
  // COMPLETED: Pass this into the TextField so that the input value persists
  ...
  Widget build(BuildContext context) {
    ...
    // COMPLETED: Use a ListView instead of a Column
    ...
    // COMPLETED: Use an OrientationBuilder to add a width to the unit converter
    // in landscape mode
    return Padding(
      padding: _padding,
