...
class _CategoryRouteState extends State<CategoryRoute> {
  ...
  // Completed: Remove _categoryNames as they will be retrieved from the JSON asset
  ...
  // COMPLETED: Remove the overriding of initState(). Instead, we use
  // didChangeDependencies()

  // COMPLETED: Uncomment this out. We use didChangeDependencies() so that we can
  ...
  Future<void> _retrieveLocalCategories() async {
    ...
    // COMPLETED: Create Categories and their list of Units, from the JSON asset
    var categoryIndex = 0;
  ...
  // COMPLETED: Delete this function; instead, read in the units from the JSON asset
